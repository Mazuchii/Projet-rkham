...
if (localStorage.getItem('darkMode') === 'enabled') {
    ...
    document.querySelectorAll('.header, .nav ul li a, .hero, .hero-overlay, .catalog, .footer, .contact form, .testimonials, section, article, aside, button, input[type="submit"], .card, img, .features, .features-grid, .feature, .feature img, .feature h3, .feature p')
