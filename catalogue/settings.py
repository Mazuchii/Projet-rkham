...
TATIC_URL = '/static/'  # URL to access static files

STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Path where collectstatic gathers files

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Your static source directory
]
